...
const quickCards = [
  { label: "Install", cmd: "curl -fsSL https://raw.githubusercontent.com/Knobase-AI/openclaw-knobase/main/install.sh | bash" },
...
function StepCard({
  ...
  const currentCommand = hasTabs
    ...
    : step.command!;
  const currentOutput = hasTabs
    ? step.tabs![activeTab].output
    : step.output!;
            ...
            <FadeUp delay={0.2}>
              <div className="mt-16 rounded-2xl border border-neutral-200 bg-white p-6 sm:p-8">
                ...
                <p className="mt-1 mb-5 text-sm text-neutral-500">
                  For power users who want to run everything at once. Only use if
