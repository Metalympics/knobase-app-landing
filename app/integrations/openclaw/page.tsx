  ...
  return (
    <div className="overflow-hidden rounded-xl border border-neutral-200 bg-white shadow-xl shadow-neutral-200/40">
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="rounded-lg border border-dashed border-neutral-200 bg-neutral-50 py-6 text-center">
          <Bot size={22} className="mx-auto mb-2 text-neutral-300" />
          <p className="text-xs text-neutral-400">No agents connected yet</p>
        </div>
        <button className="w-full rounded-lg bg-[#650BD8] py-2.5 text-sm font-medium text-white transition-colors hover:bg-[#5209b0]">
          Connect OpenClaw
        </button>
        <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-2 rounded-md border border-[#650BD8]/30 bg-[#650BD8]/3 px-3 py-2 ring-1 ring-[#650BD8]/20">
            <code className="flex-1 truncate text-[11px] text-neutral-500">
              http://localhost:3000/gateway
            </code>
            <span className="text-[10px] font-medium text-[#650BD8]">
              Connect →
            </span>
          </div>
        </div>
...
const steps = [
  {
    ...
    icon: Zap,
    mockup: <MockConnectSettings />,
    instructions: [
      "Go to Settings → Agents in your Knobase workspace",
...
const faqs = [
  ...
  },
  {
    ...
    a: "Check that your OpenClaw gateway is running and the URL is correct. You can verify the connection status in Settings → Agents.",
  },
  {
      ...
      <section className="relative overflow-hidden px-4 pt-20 pb-24 sm:px-6 sm:pt-28 sm:pb-32 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            >
              <div className="flex h-6 w-6 items-center justify-center rounded-md bg-[#650BD8]">
            ...
            >
              {[
                { label: "Connect in Settings", time: "1 min" },
            ...
            <div className="relative">
              ...
              <div className="mt-10 flex flex-wrap items-center justify-center gap-6">
                {[
                  ...
                  { icon: Users, label: "1,000+ workspaces" },
